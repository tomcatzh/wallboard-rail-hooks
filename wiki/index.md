...
- EN: [frame-ribba22](accessories/frame-ribba22.md) — pair-use 24 mm-wide saddle (`accessories/frames/ribba-22.scad`) for the measured 22 mm recessed back of an old IKEA RIBBA 18288 frame; the raised free bearing edge is 12 mm below the fixed mount top, with an exact 22 mm flat reach and a full-width 13 × 10 mm diagonal gusset using tangent R1.5 concave inner fillets.
  ZH: [frame-ribba22](accessories/frame-ribba22.md) —— 为旧款 IKEA RIBBA 18288 相框实测 22 mm 凹背设计的双只托架（`accessories/frames/ribba-22.scad`），每只宽 24 mm；抬高后的自由端上缘距固定安装头顶部 12 mm，平直托面精确伸入 22 mm，并采用带相切 R1.5 内弧的全宽 13 × 10 mm 斜撑。
