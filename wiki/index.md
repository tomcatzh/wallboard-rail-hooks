...
- EN: [frame-ribba22](accessories/frame-ribba22.md) — minimal-height 33.6 mm, pair-use 24 mm-wide saddle (`accessories/frames/ribba-22.scad`) for the measured 22 mm recessed back of an old IKEA RIBBA 18288 frame; its flat bearing reach is exactly 22 mm, with a flush vertical front and an R1 root fillet.
  ZH: [frame-ribba22](accessories/frame-ribba22.md) —— 为旧款 IKEA RIBBA 18288 相框实测 22 mm 凹背设计的 33.6 mm 最短双只托架（`accessories/frames/ribba-22.scad`），每只宽 24 mm，平直托面精确伸入 22 mm，正面齐平并带 R1 根部圆角。
