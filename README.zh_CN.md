...
| RIBBA 22 款 | `accessories/frames/ribba-22.scad` | 总高 33.6 mm 的最短双只托架，每只宽 24 mm，平直托面精确伸入 22 mm，正面齐平并带 R1 根部圆角 |
...
- RIBBA 22 款侧面朝下打印，无需支撑；使用时应将两只分开放置。用户的旧款 RIBBA 18288 相框已完成实物配合并成功挂上，但本托架仍无长期承载额定值。
